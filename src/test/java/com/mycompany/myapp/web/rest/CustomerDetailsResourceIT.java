...
public class CustomerDetailsResourceIT {
    ...
    public void createCustomerDetails() throws Exception {
        ...
        assertThat(testCustomerDetails.getId()).isEqualTo(testCustomerDetails.getUser().getId());
    }
    ...
    @Test
    @Transactional
    public void updateCustomerDetailsMapsIdAssociationWithNewId() throws Exception {
