...
export class ProductCategoryComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.productCategoryService
      ...
      .subscribe(
        (res: HttpResponse<IProductCategory[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInProductCategories(): void {
    this.eventSubscriber = this.eventManager.subscribe('productCategoryListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IProductCategory[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
