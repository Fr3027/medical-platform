...
export class CartItemComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.cartItemService
      ...
      .subscribe(
        (res: HttpResponse<ICartItem[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInCartItems(): void {
    this.eventSubscriber = this.eventManager.subscribe('cartItemListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: ICartItem[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
